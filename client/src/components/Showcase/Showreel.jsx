...
function Showreel() {
  return (
    <div className='flex flex-col lg:flex-row px-4 lg:px-20 items-center my-20 font-mont gap-14'>
      <div className='lg:w-[60%]'>
        <h1 className='font-extrabold text-5xl lg:text-6xl'>SHOW<span className='text-[#53ADC0]'>REEL</span></h1>
        <img src={image} alt="" className='w-full' />
      </div>
      <div className='lg:w-[40%] flex flex-col gap-4 text-[#5C5C5C] leading-[1.5rem] items-center lg:items-start'>
        <h2 className='font-bold text-4xl text-left w-full ml-5 lg:text-5xl text-black'>Its Show Time!</h2>
