    ...
    return (
        <div className='flex flex-col lg:flex-row items-center px-8 lg:px-20 my-20 font-mont gap-5 lg:gap-0'>
            ...
            <div className='lg:w-[35%] flex flex-col gap-4 text-[#5C5C5C] leading-[1.5rem] items-center lg:items-start'>
                <h2 className='font-bold text-4xl lg:text-5xl text-black'>Unique Solutions for You Business</h2>
                <p className='lg:w-[90%]'>{`Fly place spirit second rule dry he herb green can't
                    created said forth seas light without female land
                    saw very years day him.`}</p>
                <p className='lg:w-[90%]'>{`Waters day of brought wherein night isn't night make
                ...
                <p className='lg:w-[90%]'>{`Fly place spirit second rule dry he herb green can't
                    created said forth seas light without female land
                    saw very years day him.`}</p>
                <p className='lg:w-[90%]'>{`Fly place spirit second rule dry he herb green can't`}</p>
